...
#define _DMLLIB_LOG_WARNING(dev, grps, ...) do {                              \
    void (*log_warning)(conf_object_t *NOTNULL, uint64, const char *NOTNULL,  \
                        ...)                                                  \
        = (void (*)(conf_object_t *NOTNULL, uint64, const char *NOTNULL, ...) \
          )SIM_get_api_function("VT_log_warning");                            \
    if (log_warning) {                                                        \
